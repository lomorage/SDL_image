...
pkgdatadir = $(datadir)/SDL_image
pkgincludedir = $(includedir)/SDL_image
pkglibdir = $(libdir)/SDL_image
pkglibexecdir = $(libexecdir)/SDL_image
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(libSDL_imageinclude_HEADERS) \
	$(am__DIST_COMMON)
...
am__libSDL_image_la_SOURCES_DIST = IMG.c IMG_bmp.c IMG_gif.c IMG_jpg.c \
	...
	IMG_xcf.c IMG_xpm.c IMG_xv.c IMG_webp.c IMG_heic.c \
	IMG_ImageIO.m
...
am__depfiles_remade = ./$(DEPDIR)/IMG.Plo ./$(DEPDIR)/IMG_ImageIO.Plo \
	...
	./$(DEPDIR)/IMG_heic.Plo ./$(DEPDIR)/IMG_jpg.Plo \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/SDL_image.pc.in \
	$(srcdir)/SDL_image.spec.in COPYING README compile \
...
CFLAGS = -I/usr/local/include/libpng16 -I/opt/lib/libjpeg-turbo/include -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/include/SDL
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -DPACKAGE=\"SDL_image\" -DVERSION=\"1.2.12\" -DLOAD_JPG=1 -DLOAD_PNG=1 -DLOAD_HEIC=1 -DLOAD_BMP=1 -DLOAD_GIF=1 -DLOAD_LBM=1 -DLOAD_PCX=1 -DLOAD_PNM=1 -DLOAD_TGA=1 -DLOAD_XCF=1 -DLOAD_XPM=1 -DLOAD_XV=1
DEPDIR = .deps
DLLTOOL = dlltool
DSYMUTIL = 
DUMPBIN = 
...
FGREP = /bin/grep -F
GREP = /bin/grep
IMG_LIBS = -lheif -lz -lpng -lz -ljpeg 
...
INTERFACE_AGE = 4
LD = /usr/bin/ld
LDFLAGS = -L/opt/lib/libjpeg-turbo/lib32
LIBOBJS = 
LIBPNG_CFLAGS = -I/usr/local/include/libpng16
...
OBJCFLAGS = -I/usr/local/include/libpng16 -I/opt/lib/libjpeg-turbo/include -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/include/SDL
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
OTOOL64 = 
...
VERSION = 1.2.12
WINDRES = 
abs_builddir = /home/pi/SDL_image-1.2.12
abs_srcdir = /home/pi/SDL_image-1.2.12
abs_top_builddir = /home/pi/SDL_image-1.2.12
abs_top_srcdir = /home/pi/SDL_image-1.2.12
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
ac_ct_OBJC = gcc
am__include = include
...
install_sh = ${SHELL} /home/pi/SDL_image-1.2.12/install-sh
...
libSDL_image.la: $(libSDL_image_la_OBJECTS) $(libSDL_image_la_DEPENDENCIES) $(EXTRA_libSDL_image_la_DEPENDENCIES) 
	$(AM_V_OBJCLD)$(libSDL_image_la_LINK) -rpath $(libdir) $(libSDL_image_la_OBJECTS) $(libSDL_image_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/IMG_heic.Plo # am--include-marker
...
install-libSDL_imageincludeHEADERS: $(libSDL_imageinclude_HEADERS)
	...
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(libSDL_imageincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(libSDL_imageincludedir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
...
uninstall-libSDL_imageincludeHEADERS:
	...
	@list='$(libSDL_imageinclude_HEADERS)'; test -n "$(libSDL_imageincludedir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(libSDL_imageincludedir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(libSDL_imageincludedir)"; do \
...
install-data-am: install-libSDL_imageincludeHEADERS \
