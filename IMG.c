...
static struct {
	...
	{ "PNG", IMG_isPNG, IMG_LoadPNG_RW },
        { "HEIC", IMG_isHEIC, IMG_LoadHEIC_RW },
...
extern int IMG_InitHEIC();
extern void IMG_QuitHEIC();
...
int IMG_Init(int flags)
{
    ...
    if (flags & IMG_INIT_HEIC) {
        if ((initialized & IMG_INIT_HEIC) || IMG_InitHEIC() == 0) {
            result |= IMG_INIT_HEIC;
        }
    }
